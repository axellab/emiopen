<%@ Page Language="VB" AutoEventWireup="false" CodeFile="competencias.aspx.vb" Inherits="css_competencias" %>
...
<!-- menu -->
    ...
    <div class="row contenedor div2">
        <div class="col-sm-6 col-md-10"><input type="button" class="btn btn-dark" style="margin-bottom: 10px;" id="nuevacompetencia" value="Nueva competencia"></div>
        <br>
        <div class="col-sm-6 col-md-2">
        <select class="form-control select" id="filtro" style="display:none">
            <option>Todos</option>
            <option>A disputarse</option>
            <option>En curso</option>
            <option>Finalizadas</option>
        </select>
        </div>
        <div class="col-md-12 col-sm-12 margen"></div>
    <div class="col-md-12 col-sm-12" id="area">
    ...
    <script type="text/javascript">
      ...
      function () {
        ...
        $(document).ready(function () {
            ...
            $("#nuevacompetencia").click(() => {
                window.location.replace('http://44.204.37.84/ADMIN/formularios/formcompetencia.aspx?id=0')
            })
            ...
            xhr.onload = function () {
                ...
                for (x of json) {
                    dev = dev + "<div class='container col-12'> <div class='Area-1'> " + x.nombre + " </div> <div class='Area-2'> <p class='info'><b> " + x.tipo + "</b><br><b> " + x.estado + "</b><br></p> </div> <div class='Area-3'> <input type='button' class='btn btn-dark botoneditar2' value='Editar' onclick='ir(" + x.id + ")'>  </div> </div>"
                    console.log(x);
                }
                $("#area").html(dev);
