<%@ Page Language="VB" AutoEventWireup="false" CodeFile="formsede.aspx.vb" Inherits="formularios_formsede" %>
        ...
        <form>
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="inputState">Nombre de la sede</label>
                    <input type="text" class="form-control" id="nombre" placeholder="Nombre de la sede">
                </div>
                <div class="form-group col-md-6">
      ...
      function () {
        ...
        $(document).ready(function () {
            ...
            $("#eliminar").click(() => {
                ...
                var dev = "";
                xhr.send(json);
                xhr.onload = function () { window.location.replace('http://44.204.37.84/ADMIN/sedes.aspx'); }
            });
            ...
            $("#guardar").click(() => {
                ...
                if (document.all['direccion'].value == "") {
                    document.all['direccion'].style.backgroundColor = 'red';
                    setTimeout("document.all['direccion'].style.backgroundColor =  'white';", 2000);
                    return;
                }
                ...
                if (anuncioParam == 0) {
                    ...
                    json = JSON.stringify({
                        ...
                        direccion: document.all['direccion'].value
                        });
                } else {
