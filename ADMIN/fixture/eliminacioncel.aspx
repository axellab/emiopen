<%@ Page Language="VB" AutoEventWireup="false" CodeFile="eliminacioncel.aspx.vb" Inherits="fixture_eliminacioncel" %>
...
<head>
  <meta charset="UTF-8">
  <title>Eliminación smartphone</title>
...
<!--Fin de menú-->
  ...
  <div class="swiper-container swiper-container-h">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide" style="height:87vh; overflow:auto; position:relative; padding-top:  30px;">

        <div class="row margen2">
          <div class="col-12">
            <h2>OCTAVOS</h2><br>
          </div>
          <div class="col-sm-12 col-md-12 div" style="margin-bottom: 30px;">
            <div class="card2">
              <div class="row">
                <div class="col-7">
