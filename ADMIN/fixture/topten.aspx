<%@ Page Language="VB" AutoEventWireup="false" CodeFile="topten.aspx.vb" Inherits="fixture_topten" %>
        ...
        <div class="row" style="padding-left:20px;">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <table class="table table-dark" style="padding-left:10px;">
                    ...
                    <tbody id="area">
                        <tr>
                            <td class="resultp"><b>1 - LUCIANA ERNETA</b></td>
                            <td>0</td>
                            <td>0</td>
                            <td>0</td>
                            <td>0</td>
      ...
      console.log('El DOM  esta listo!');
        ...
        if (anuncioParam > 0) {
            ...
            xhr.onload = function () {
                ...
                console.log("crudo", json);
                ordenarDesc(json, 'PG');
                console.log("ordenado", json);
                ...
                for (x of json) {
                        ...
                        if (orden == 1) {
                            dev = dev + "  <td class='resultp'><b>" + orden + " - " + x.nombre + "</b></td>"
                        } else {
                            dev = dev + "  <td class=''><b>" + orden + " - " + x.nombre + "</b></td>"
                        }
                          ...
                          if (orden == 1) {
                              dev = dev + " <td  class='resultp'><B>" + x.PG + "</B></td>"
                          } else {
                              dev = dev + " <td  class=''><B>" + x.PG + "</B></td>"
                          }
                       dev  = dev + " </tr>"
                        orden = orden + 1
                    }
