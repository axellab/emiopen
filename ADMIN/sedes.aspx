<%@ Page Language="VB" AutoEventWireup="false" CodeFile="sedes.aspx.vb" Inherits="sedes" %>
...
<!-- menu -->
    ...
    <div class="row contenedor div2">
        <div class="col-sm-6 col-md-10"><input type="button" class="btn btn-dark" value="Nueva sede" id="nuevasede"></div>
     ...
     <script type="text/javascript">
      ...
      function () {
        ...
        $(document).ready(function () {
            ...
            $("#nuevasede").click(() => {
                window.location.replace('http://44.204.37.84/ADMIN/formularios/formsede.aspx?id=0')
            })
            ...
            xhr.onload = function () {
                ...
                for (x of json) {
                    dev = dev + "<div class='container col-12'> <div class='Area-1'>" + x.nombre + "<br/> </div> <div class='Area-2'></div> <div class='Area-3'> <input type='button' class='btn btn-dark botoneditar' value='Editar' onclick='ir(" + x.id + ")'> </div> </div>"
                    console.log(x);
                }
                $("#area").html(dev);
        ...
        function ir(id) {
            window.location = "http://44.204.37.84/ADMIN/formularios/formsede.aspx?id=" + id
        }
    </script>
</body>
</html>